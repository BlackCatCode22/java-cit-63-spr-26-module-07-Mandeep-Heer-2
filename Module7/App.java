...
public class App {
    ...
    public static void main(String[] args) {
        System.out.println("Module 7 Refined Zookeeper's Challenge");
        System.out.println("Currently processing the incoming animal data from the files...\n");

        String filePath = "src/Module7/animalNames.txt";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/Module7/arrivingAnimals.txt"))) {
            String line;
        ...
        while (keepRunning) {
            ...
            if (choice.equals("1")) {
                try (BufferedWriter writer = new BufferedWriter(new FileWriter("src/Module7/zooPopulation.txt"))) {
                ...
                try (BufferedWriter appendWriter = new BufferedWriter(new FileWriter("src/Module7/arrivingAnimals.txt", true))) {
